                    ...
                    <div class="search-result__content">
                        ...
                        <div class="mb-5">
                            <a href="#" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full"
                                        src="{{ asset('admin/assets/images/profile-7.jpg') }}">
                                </div>
                            ...
                            <a href="#" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full"
                                        src="{{ asset('admin/assets/images/profile-2.jpg') }}">
                                </div>
                            ...
                            <a href="#" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full"
                                        src="{{ asset('admin/assets/images/profile-5.jpg') }}">
                                </div>
                                <div class="ml-3">Johnny Depp</div>
                                <div class="ml-auto w-48 truncate text-slate-500 text-xs text-right">
                                    johnnydepp@left4code.com</div>
                            ...
                            <a href="#" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full"
                                        src="{{ asset('admin/assets/images/profile-9.jpg') }}">
                                </div>
                        ...
                        <a href="#" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Midone - HTML Admin Template" class="rounded-full"
                                    src="{{ asset('admin/assets/images/preview-9.jpg') }}">
                            </div>
                        ...
                        <a href="#" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Midone - HTML Admin Template" class="rounded-full"
                                    src="{{ asset('admin/assets/images/preview-1.jpg') }}">
                            </div>
                        ...
                        <a href="#" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Midone - HTML Admin Template" class="rounded-full"
                                    src="{{ asset('admin/assets/images/preview-2.jpg') }}">
                            </div>
                        ...
                        <a href="#" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Midone - HTML Admin Template" class="rounded-full"
                                    src="{{ asset('admin/assets/images/preview-8.jpg') }}">
                            </div>
                ...
                <div class="notification-content pt-2 dropdown-menu">
                    <div class="notification-content__box dropdown-content">
                        ...
                        <div class="cursor-pointer relative flex items-center mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Midone - HTML Admin Template" class="rounded-full"
                                    src="{{ asset('admin/assets/images/profile-1.jpg') }}">
                                <div
                                    class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600">
                                </div>
                            </div>
                    ...
                    <div class="col-span-12 xl:col-span-8 mt-6">
                        ...
                        <div class="intro-y box p-5 mt-12 sm:mt-5">
                            ...
                            <div class="report-maps mt-5 bg-slate-200 rounded-md" data-center="-6.2425342, 106.8626478"
                                data-sources="admin/assets/json/location.json">
                            </div>
                        </div>
                    </div>
                    <!-- END: Official Store -->
                        ...
                        <div class="mt-5">
                                ...
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template"
                                            src="{{ asset('admin/assets/images/profile-14.jpg') }}">
                                    </div>
                            ...
                            <div class="intro-y">
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template"
                                            src="{{ asset('admin/assets/images/profile-11.jpg') }}">
                                    </div>
                                    <div class="ml-4 mr-auto">
                            ...
                            <div class="intro-y">
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template"
                                            src="{{ asset('admin/assets/images/profile-13.jpg') }}">
                                    </div>
                                    <div class="ml-4 mr-auto">
                                            ...
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        src="{{ asset('admin/assets/images/preview-12.jpg') }}"
                                                        title="Uploaded at 3 June 2020">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        src="{{ asset('admin/assets/images/preview-6.jpg') }}"
                                                        title="Uploaded at 6 August 2020">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        src="{{ asset('admin/assets/images/preview-13.jpg') }}"
                                    ...
                                    <tr class="intro-x">
                                        <td class="w-40">
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        src="{{ asset('admin/assets/images/preview-15.jpg') }}"
                                                        title="Uploaded at 18 October 2022">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        src="{{ asset('admin/assets/images/preview-5.jpg') }}"
                                    ...
                                    <tr class="intro-x">
                                        <td class="w-40">
                                            <div class="flex">
                                                ...
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        src="{{ asset('admin/assets/images/preview-14.jpg') }}"
                            ...
                            <div
                                ...
                                <div class="intro-x relative flex items-center mb-3">
                                    <div
                                        ...
                                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Midone - HTML Admin Template"
                                                src="{{ asset('admin/assets/images/profile-12.jpg') }}">
                                        </div>
                                    </div>
                                ...
                                <div class="intro-x relative flex items-center mb-3">
                                    <div
                                        ...
                                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Midone - HTML Admin Template"
                                                src="{{ asset('admin/assets/images/profile-6.jpg') }}">
                                        </div>
                                    </div>
                                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        <div class="flex items-center">
