                                    ...
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                src="dist/images/preview-4.jpg" title="Uploaded at 28 May 2020">
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-slate-500 whitespace-nowrap mt-0.5">{{ $user->name }}</div>
                                </td>
                                <td>
                                    <div class="text-slate-500 whitespace-nowrap mt-0.5">{{ $user->email }}</div>
                                </td>

                                <td class="table-report__action w-56">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="javascript:;" title="Edit"> <i
                                                data-lucide="check-square" class="w-4 h-4 mr-1"></i> </a>

                                        <a title="view" class="flex items-center mr-3" href="javascript:;" title="Edit">
