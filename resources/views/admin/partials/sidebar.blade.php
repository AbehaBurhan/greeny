<nav class="side-nav">
    ...
    <ul>
        ...
        {{-- catagory part ends here --}}

        {{-- shipping part starts here --}}

        <li>
            <a href="{{ route('shipping.index') }}"
                class="side-menu {{ request()->routeIs('shipping.index') ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon"> <i data-lucide="edit"></i> </div>
                <div class="side-menu__title">
                    Shipping Type
                    {{-- <div class="side-menu__sub-icon "> <i data-lucide="chevron-down"></i> </div> --}}
            ...
            {{-- <ul class="">
                <li>
                    <a href="{{ route('shipping.index') }}" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
        ...
        {{-- shipping part ends here --}}

        {{-- product part satrts here --}}
        ...
        {{-- brands part starts here --}}

        <li>
            <a href="{{ route('brand.index') }}"
                class="side-menu {{ request()->routeIs('brand.index') ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon"> <i data-lucide="edit"></i> </div>
                <div class="side-menu__title">
                    Brands
                    {{-- <div class="side-menu__sub-icon "> <i data-lucide="chevron-down"></i> </div> --}}
