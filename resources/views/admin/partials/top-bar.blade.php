<div class="top-bar">
            ...
            <div class="search-result__content">
                ...
                <div class="mb-5">
                    ...
                    <a href="#" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Midone - HTML Admin Template" class="rounded-full"
                                src="{{ asset('admin/assets/dist/images/profile-8.jpg') }}">
                        </div>
                        <div class="ml-3">Al Pacino</div>
                        <div class="ml-auto w-48 truncate text-slate-500 text-xs text-right">alpacino@left4code.com
                        </div>
                    ...
                    <a href="#" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Midone - HTML Admin Template" class="rounded-full"
                                src="{{ asset('admin/assets/dist/images/profile-6.jpg') }}">
                        </div>
                ...
                <a href="#" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone - HTML Admin Template" class="rounded-full"
                            src="{{ asset('admin/assets/dist/images/preview-11.jpg') }}">
                    </div>
                ...
                <a href="#" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone - HTML Admin Template" class="rounded-full"
                            src="{{ asset('admin/assets/images/preview-7.jpg') }}">
                    </div>
                ...
                <a href="#" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone - HTML Admin Template" class="rounded-full"
                            src="{{ asset('admin/assets/images/preview-10.jpg') }}">
                    </div>
    ...
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button"
            ...
            <img alt="Midone - HTML Admin Template" src="{{ asset('admin/assets/images/profile-15.jpg') }}">
        </div>
