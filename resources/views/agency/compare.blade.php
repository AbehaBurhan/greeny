                        ...
                        <table class="table-list">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="table-image"><img src="{{ asset('agency/assets/images/product/01.jpg') }}"
                                            alt="product"></td>
                                    <td class="table-name">
                                        <h6>product name</h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="table-image"><img src="{{ asset('agency/assets/images/product/02.jpg') }}"
                                            alt="product"></td>
                                    <td class="table-name">
                                        <h6>product name</h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="table-image"><img src="{{ asset('agency/assets/images/product/03.jpg') }}"
                                            alt="product"></td>
                                    <td class="table-name">
                                        <h6>product name</h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="table-image"><img src="{{ asset('agency/assets/images/product/04.jpg') }}"
                                            alt="product"></td>
                                    <td class="table-name">
                                        <h6>product name</h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="table-image"><img src="{{ asset('agency/assets/images/product/05.jpg') }}"
                                            alt="product"></td>
                                    <td class="table-name">
                                        <h6>product name</h6>
                                    </td>
