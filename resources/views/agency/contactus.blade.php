            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="branch-card">
                        <img src="{{ asset('agency/assets/images/branch/01.jpg') }}" alt="branch">
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="branch-card">
                        <img src="{{ asset('agency/assets/images/branch/02.jpg') }}" alt="branch">
                        <div class="branch-overlay">
                            <h3>Narayanganj</h3>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="branch-card">
                        <img src="{{ asset('agency/assets/images/branch/03.jpg') }}" alt="branch">
                        <div class="branch-overlay">
                            <h3>chandpur</h3>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="branch-card">
                        <img src="{{ asset('agency/assets/images/branch/04.jpg') }}" alt="branch">
                        <div class="branch-overlay">
                            <h3>noakhli</h3>
