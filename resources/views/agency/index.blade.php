    ...
    <section class="home-index-slider slider-arrow slider-dots">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-content">
                            ...
                            <div class="banner-btn"><a class="btn btn-inline" href="shop-4column.html"><i
                                    ...
                                    class="btn btn-outline" href="{{ route('offer') }}"><i
                                        class="icofont-sale-discount"></i><span>get
                                        offer</span></a></div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-img"><img src="{{ asset('agency/assets/images/home/index/01.png') }}"
                                alt="index"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="banner-part banner-2">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-img"><img src="{{ asset('agency/assets/images/home/index/02.png') }}"
                                alt="index"></div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-content">
    ...
    <section class="section suggest-part">
        <div class="container">
            <ul class="suggest-slider slider-arrow">
                <li><a class="suggest-card" href="shop-4column.html"><img
                            src="{{ asset('agency/assets/images/suggest/01.jpg') }}" alt="suggest">
                        <h5>vegetables <span>34 items</span></h5>
                    </a></li>
                <li><a class="suggest-card" href="shop-4column.html"><img
                            src="{{ asset('agency/assets/images/suggest/02.jpg') }}" alt="suggest">
                        <h5>fruits <span>89 items</span></h5>
                    </a></li>
                <li><a class="suggest-card" href="shop-4column.html"><img
                            src="{{ asset('agency/assets/images/suggest/03.jpg') }}" alt="suggest">
                        <h5>groceries <span>45 items</span></h5>
                    </a></li>
                <li><a class="suggest-card" href="shop-4column.html"><img
                            src="{{ asset('agency/assets/images/suggest/04.jpg') }}" alt="suggest">
                        <h5>dairy farm <span>83 items</span></h5>
                    </a></li>
                <li><a class="suggest-card" href="shop-4column.html"><img
                            src="{{ asset('agency/assets/images/suggest/05.jpg') }}" alt="suggest">
                        <h5>sea foods <span>40 items</span></h5>
                    </a></li>
                <li><a class="suggest-card" href="shop-4column.html"><img
                            src="{{ asset('agency/assets/images/suggest/06.jpg') }}" alt="suggest">
                        <h5>vegan foods <span>57 items</span></h5>
                    </a></li>
                <li><a class="suggest-card" href="shop-4column.html"><img
                            src="{{ asset('agency/assets/images/suggest/07.jpg') }}" alt="suggest">
                        <h5>dry foods <span>23 items</span></h5>
                    </a></li>
                <li><a class="suggest-card" href="shop-4column.html"><img
                            src="{{ asset('agency/assets/images/suggest/08.jpg') }}" alt="suggest">
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a class="product-image"
                        ...
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                class="product-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/02.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                class="product-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/03.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                class="product-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/04.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                class="product-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/05.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                class="product-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/06.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                class="product-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/07.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                class="product-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/08.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                class="product-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/09.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                class="product-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/10.jpg') }}" alt="product" /></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="promo-img"><a href="#"><img
                                src="{{ asset('agency/assets/images/promo/home/03.jpg') }}" alt="promo"></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col">
                    <div class="feature-card">
                        <div class="feature-media">
                            ...
                            <button class="feature-wish wish"><i class="fas fa-heart"></i></button><a
                                class="feature-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/11.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="feature-card">
                        <div class="feature-media">
                            ...
                            <button class="feature-wish wish"><i class="fas fa-heart"></i></button><a
                                class="feature-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/12.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="feature-card">
                        <div class="feature-media">
                            ...
                            <button class="feature-wish wish"><i class="fas fa-heart"></i></button><a
                                class="feature-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/13.jpg') }}" alt="product" /></a>
                ...
                <div class="col">
                    <div class="feature-card">
                        <div class="feature-media">
                            ...
                            <button class="feature-wish wish"><i class="fas fa-heart"></i></button><a
                                class="feature-image" href="product-video.html"><img
                                    src="{{ asset('agency/assets/images/product/14.jpg') }}" alt="product" /></a>
    ...
    <section class="section countdown-part">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="countdown-img"><img src="{{ asset('agency/assets/images/countdown.png') }}"
                            alt="countdown">
                        ...
                        <li>
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                        class="product-image" href="product-video.html"><img
                                            src="{{ asset('agency/assets/images/product/15.jpg') }}"
                                            alt="product" /></a>
                        ...
                        <li>
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                        class="product-image" href="product-video.html"><img
                                            src="{{ asset('agency/assets/images/product/16.jpg') }}"
                                            alt="product" /></a>
                        ...
                        <li>
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                        class="product-image" href="product-video.html"><img
                                            src="{{ asset('agency/assets/images/product/17.jpg') }}"
                                            alt="product" /></a>
                        ...
                        <li>
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                        class="product-image" href="product-video.html"><img
                                            src="{{ asset('agency/assets/images/product/18.jpg') }}"
                                            alt="product" /></a>
                        ...
                        <li>
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                        class="product-image" href="product-video.html"><img
                                            src="{{ asset('agency/assets/images/product/19.jpg') }}"
                                            alt="product" /></a>
                        ...
                        <li>
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                        class="product-image" href="product-video.html"><img
                                            src="{{ asset('agency/assets/images/product/20.jpg') }}"
                                            alt="product" /></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6 px-xl-3">
                    <div class="promo-img"><a href="#"><img
                                src="{{ asset('agency/assets/images/promo/home/01.jpg') }}" alt="promo"></a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6 px-xl-3">
                    <div class="promo-img"><a href="#"><img
                                src="{{ asset('agency/assets/images/promo/home/02.jpg') }}" alt="promo"></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col">
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                    class="product-image" href="product-video.html"><img
                                        src="{{ asset('agency/assets/images/product/01.jpg') }}" alt="product" /></a>
                    ...
                    <div class="col">
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                    class="product-image" href="product-video.html"><img
                                        src="{{ asset('agency/assets/images/product/15.jpg') }}" alt="product" /></a>
                    ...
                    <div class="col">
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                    class="product-image" href="product-video.html"><img
                                        src="{{ asset('agency/assets/images/product/16.jpg') }}" alt="product" /></a>
                    ...
                    <div class="col">
                        <div class="product-card product-disable">
                            <div class="product-media">
                                ...
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                    class="product-image" href="product-video.html"><img
                                        src="{{ asset('agency/assets/images/product/17.jpg') }}" alt="product" /></a>
        ...
        <div class="container">
            ...
            <div class="brand-slider slider-arrow">
                <div class="brand-wrap">
                    <div class="brand-media"><img src="{{ asset('agency/assets/images/brand/01.jpg') }}"
                            alt="brand">
                        <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
                ...
                <div class="brand-wrap">
                    <div class="brand-media"><img src="{{ asset('agency/assets/images/brand/02.jpg') }}"
                            alt="brand">
                        <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
                ...
                <div class="brand-wrap">
                    <div class="brand-media"><img src="{{ asset('agency/assets/images/brand/03.jpg') }}"
                            alt="brand">
                        <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
                ...
                <div class="brand-wrap">
                    <div class="brand-media"><img src="{{ asset('agency/assets/images/brand/04.jpg') }}"
                            alt="brand">
                        <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
                ...
                <div class="brand-wrap">
                    <div class="brand-media"><img src="{{ asset('agency/assets/images/brand/05.jpg') }}"
                            alt="brand">
                        <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
                ...
                <div class="brand-wrap">
                    <div class="brand-media"><img src="{{ asset('agency/assets/images/brand/06.jpg') }}"
                            alt="brand">
                        <div class="brand-overlay"><a href="brand-single.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-slider slider-arrow">
                        <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                            ...
                            <ul>
                                ...
                                <li class="fas fa-star"></li>
                                <li class="fas fa-star"></li>
                            </ul><img src="{{ asset('agency/assets/images/avatar/01.jpg') }}" alt="testimonial">
                        </div>
                        <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                            <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati
                                magnam doloribus magni provident ipsam</p>
                            ...
                            <ul>
                                ...
                                <li class="fas fa-star"></li>
                                <li class="fas fa-star"></li>
                            </ul><img src="{{ asset('agency/assets/images/avatar/02.jpg') }}" alt="testimonial">
                        </div>
                        <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                            <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati
                                magnam doloribus magni provident ipsam</p>
                            ...
                            <ul>
                                ...
                                <li class="fas fa-star"></li>
                                <li class="fas fa-star"></li>
                            </ul><img src="{{ asset('agency/assets/images/avatar/03.jpg') }}" alt="testimonial">
                        </div>
                        <div class="testimonial-card"><i class="fas fa-quote-left"></i>
                            <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati
                                magnam doloribus magni provident ipsam</p>
                            ...
                            <ul>
                                ...
                                <li class="fas fa-star"></li>
                                <li class="fas fa-star"></li>
                            </ul><img src="{{ asset('agency/assets/images/avatar/04.jpg') }}" alt="testimonial">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section blog-part">
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="blog-slider slider-arrow">
                        <div class="blog-card">
                            <div class="blog-media">
                                <a class="blog-img" href="#"><img
                                        src="{{ asset('agency/assets/images/blog/01.jpg') }}" alt="blog" /></a>
                            </div>
                            <div class="blog-content">
                                ...
                                <p class="blog-desc">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Alias autem
                                    recusandae deleniti nam dignissimos sequi ...</p>
                        ...
                        <div class="blog-card">
                            <div class="blog-media">
                                <a class="blog-img" href="#"><img
                                        src="{{ asset('agency/assets/images/blog/02.jpg') }}" alt="blog" /></a>
                            </div>
                            <div class="blog-content">
                                <ul class="blog-meta">
                                    <li><i class="fas fa-user"></i><span>admin</span></li>
                        ...
                        <div class="blog-card">
                            <div class="blog-media">
                                <a class="blog-img" href="#"><img
                                        src="{{ asset('agency/assets/images/blog/03.jpg') }}" alt="blog" /></a>
                            </div>
                            <div class="blog-content">
                                <ul class="blog-meta">
                                    <li><i class="fas fa-user"></i><span>admin</span></li>
                        ...
                        <div class="blog-card">
                            <div class="blog-media">
                                <a class="blog-img" href="#"><img
                                        src="{{ asset('agency/assets/images/blog/04.jpg') }}" alt="blog" /></a>
                            </div>
                            <div class="blog-content">
                                <ul class="blog-meta">
                                    <li><i class="fas fa-user"></i><span>admin</span></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-btn-25">
                        <a href="blog-grid.html" class="btn btn-outline"><i class="fas fa-eye"></i><span>view all
                                blog</span></a>
                    </div>
                </div>
            </div>
