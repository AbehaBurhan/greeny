                        ...
                        <div class="account-content">
                                        ...
                                        <div class="profile-image">
                                            <a href="#">
                                                <img style="height: 60px; width:60px; border-radius: 50%;"
                                                    src="{{ asset('uploads/' . $user->image) }}" alt="user">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            @else
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="profile-image">
                                            <a href="#"><img src="{{ asset('agency/assets/images/user.png') }}"
                                                    alt="user"></a>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-5">
                                        <div class="form-group">
                                            <label class="form-label">Name</label>
                                            <input class="form-control" type="text" value="someone">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-5">
                                        <div class="form-group">
                                            <label class="form-label">Email</label>
                                            <input class="form-control" type="email" value="someone@gmail.com">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-5">
                                        <div class="form-group">
                                            <label class="form-label">phone</label>
                                            <input class="form-control" type="text" value="03216745987">
                                        </div>
                                    </div>
                                </div>
                            @endauth
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 alert fade show">
                                    <div class="payment-card payment active">
                                        <img src="{{ asset('agency/assets/images/payment/png/01.png') }}" alt="payment">
                                        <h4>card number</h4>
                                ...
                                <div class="col-md-6 col-lg-4 alert fade show">
                                    <div class="payment-card payment">
                                        <img src="{{ asset('agency/assets/images/payment/png/02.png') }}" alt="payment">
                                        <h4>card number</h4>
                                        <p><span>****</span><span>****</span><span>****</span><sup>1876</sup></p>
                                        <h5>miron mahmud</h5>
                                        <button class="trash icofont-ui-delete" title="Remove This"
                                ...
                                <div class="col-md-6 col-lg-4 alert fade show">
                                    <div class="payment-card payment">
                                        <img src="{{ asset('agency/assets/images/payment/png/03.png') }}" alt="payment">
                                        <h4>card number</h4>
                                        <p><span>****</span><span>****</span><span>****</span><sup>1876</sup></p>
                                        <h5>miron mahmud</h5>
                                        <button class="trash icofont-ui-delete" title="Remove This"
    ...
    <div class="modal fade" id="profile-edit">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="modal-form" action="{{ route('profile.update') }}" method="POST"
